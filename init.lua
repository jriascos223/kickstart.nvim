...
-- change tabs to be 4 spaces, but not fuck up other display
vim.opt.tabstop = 8
  ...
  'NMAC427/guess-indent.nvim', -- Detect tabstop and shiftwidth automatically
  {
    ...
    config = function(_, opts)
      ...
      vim.api.nvim_create_user_command('Sex', function()
        require('snacks').explorer { direction = 'horizontal' }
      end, {})

      vim.api.nvim_create_user_command('Vex', function()
        require('snacks').explorer { direction = 'vertical' }
      end, {})

      vim.api.nvim_create_user_command('Tex', function()
        require('snacks').explorer { direction = 'tab' }
      end, {})
    end,
  },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('grr', snacks.lsp_references, '[G]oto [R]eferences')
          map('gri', snacks.lsp_implementations, '[G]oto [I]mplementation')
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { kotlin = true, c = true, cpp = true }
      ...
      formatters = {
        kotlin = {
          args = { '-F', vim.api.nvim_buf_get_name(0) },
          stdin = false,
        },
      },
    },
